...
public class AdventureUtil {
    ...
    public static final String LOBBY_DESCRIPTION = "You enter the apartment complex lobby. " +
            "Half the lights are broken, and you hear eerie sounds echoing throughout the building.\n" +
            "To the North is an elevator lobby, East is a janitor’s office, " +
            "West is the security office, and south is the lounge area.";
    public static final String JANITORS_OFFICE_DESCRIPTION = "You have entered the janitor’s office, it smells awful and there is not\n" +
            "much useful stuff in the here but it might be worth it to look around.";
    public static final String SECURITY_OFFICE_DESCRIPTION = "You have entered the security office, " +
            "it is a mess and seems like someone left in a rush.\n" +
    ...
    public static final String ELEVATOR_LOBBY_DESCRIPTION = "There are four elevators, three seem " +
            "to be stuck shut but one’s door is slightly open";
    ...
    public static final String SECOND_FLOOR_LOBBY_DESCRIPTION = "You are in the second floor lobby, there is a hallway with a couple of apartments\n" +
            "to the east and to the west. It is quiet….. too quiet";
    ...
    public static final String SECOND_FLOOR_WEST_HALLWAY_DESCRIPTION = "You walk down the west hallway and see nothing but locked apartments.\n" +
            "There is a man sitting at the end of the hallway he seems to be homeless and sketchy looking.";
    ...
    public static final String THIRD_FLOOR_EAST_HALLWAY_DESCRIPTION = "You see an old man standing in towards the back of the hallway. All of the apartments are locked.";
    public static final String THIRD_FLOOR_WEST_HALLWAY_DESCRIPTION = "There is loud music playing and you can hear people partying in a couple of apartments.\n" +
    ...
    // other constants
    public static final String WIN_MESSAGE = "Congratulations you have successfully arrested the correct criminal, you really are a great detective.\n" +
            "Thank you for saving the city please play again.";
    public static final String LOOSE_MESSAGE = "Good job on getting this far but you didn’t get the right guy! Please turn in your badge or try again.";
